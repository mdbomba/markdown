# access/uploadvserrfile

**Category**: templates  
**Firmware tested**: 7.2.54.12.22642.RELEASE  
**PS Cmdlet**: `Install-VSErrorFile`

## Description

Installs vserror file.

## Endpoint

```text
POST https://<host>:<port>/access/uploadvserrfile?path=<path>[&...]
```
...
```bash
curl -sk -u "bal:PASSWORD" -X POST --data-binary "@error-page.html" "https://10.0.0.69:443/access/uploadvserrfile?path=example"
```
...
<Response stat="200" code="ok">
  <Success>
    <Data>
      <!-- uploadvserrfile operation completed -->
    </Data>
  </Success>
</Response>
```
...
curl -sk -X POST "https://10.0.0.69:443/accessv2" \
  ...
  -d '{"apiuser":"bal","apipass":"PASSWORD","cmd":"uploadvserrfile","vs":"10.0.0.50","port":"443","prot":"tcp","path":"example"}'
```
