# access/vsremovewafrule

**Category**: WAF  
**Firmware tested**: 7.2.54.12.22642.RELEASE  
**PS Cmdlet**: `Remove-AdcVsWafRule`

## Description

Removes adc vs WAF rule.

## Endpoint

```text
POST https://<host>:<port>/access/vsremovewafrule?vs=<vs>&port=<port>&prot=<prot>[&...]
```
...
```bash
curl -sk -u "bal:PASSWORD" -X POST "https://10.0.0.69:443/access/vsremovewafrule?vs=192.0.2.10&port=443&prot=tcp&rule=example-rule"
```
...
<Response stat="200" code="ok">
  <Success>
    <Data>
      <!-- vsremovewafrule operation completed -->
    </Data>
  </Success>
</Response>
```
...
curl -sk -X POST "https://10.0.0.69:443/accessv2" \
  ...
  -d '{"apiuser":"bal","apipass":"PASSWORD","cmd":"vsremovewafrule","vs":"10.0.0.50","port":"443","prot":"tcp","rule":"example"}'
```
...
- `access/getwafchangelog` — exports WAF change log
