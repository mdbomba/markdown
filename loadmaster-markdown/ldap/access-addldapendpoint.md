...
curl -sk -X POST "https://10.0.0.69:443/accessv2" \
  ...
  -d '{"apiuser":"bal","apipass":"PASSWORD","cmd":"addldapendpoint","name":"example-name","server":"example","ldapprotocol":"example","vinterval":"1","referralcount":"1","timeout":"1","adminuser":"example","adminpass":"example"}'
```
