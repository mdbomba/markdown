...
**PS Cmdlet**: `Remove-GeoIpRange`

## Description

Removes GEO IP range.

## Endpoint

```text
POST https://<host>:<port>/access/delip?ip=<ip>
```
...
```bash
curl -sk -u "bal:PASSWORD" -X POST "https://10.0.0.69:443/access/delip?ip=198.51.100.20"
```
...
curl -sk -X POST "https://10.0.0.69:443/accessv2" \
  ...
  -d '{"apiuser":"bal","apipass":"PASSWORD","cmd":"delip","ip":"10.0.0.50"}'
```
