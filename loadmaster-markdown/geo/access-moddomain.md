...
curl -sk -X POST "https://10.0.0.69:443/accessv2" \
  ...
  -d '{"apiuser":"bal","apipass":"PASSWORD","cmd":"moddomain","domain":"example.com","idpentityid":"example","idpssourl":"example","idplogoffurl":"example","idpcert":"example","spentityid":"example","spcert":"example","idp_match_cert":"1"}'
```
