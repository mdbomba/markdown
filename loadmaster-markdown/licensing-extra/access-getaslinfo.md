...
Retrieves on-premise ASL licensing server details.

## Endpoint

```text
GET https://<host>:<port>/access/getaslinfo
```
...
```bash
curl -sk -u "bal:PASSWORD" "https://10.0.0.69:443/access/getaslinfo"
```
...
curl -sk -X POST "https://10.0.0.69:443/accessv2" \
  ...
  -d '{"apiuser":"bal","apipass":"PASSWORD","cmd":"getaslinfo"}'
```
