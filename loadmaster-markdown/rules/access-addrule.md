...
**PS Cmdlet**: `New-AdcContentRule`

## Description

Creates adc content rule.

## Endpoint

```text
POST https://<host>:<port>/access/addrule?matchtype=<matchtype>&inchost=<inchost>&nocase=<nocase>[&...]
```
...
```bash
curl -sk -u "bal:PASSWORD" -X POST "https://10.0.0.69:443/access/addrule?matchtype=example&inchost=example&nocase=example"
```
...
curl -sk -X POST "https://10.0.0.69:443/accessv2" \
  ...
  -d '{"apiuser":"bal","apipass":"PASSWORD","cmd":"addrule","matchtype":"example","inchost":"1","nocase":"1","negate":"1","incquery":"1","header":"example","pattern":"example","replacement":"example","type":"allow","onlyonnoflag":"1"}'
```
