...
**PS Cmdlet**: `Get-Notice`

## Description

Retrieves or acknowledges appliance notices exposed through the REST API.

## Endpoint

```text
POST https://<host>:<port>/access/notice
```
...
```bash
curl -sk -u "bal:PASSWORD" -X POST "https://10.0.0.69:443/access/notice"
```
...
curl -sk -X POST "https://10.0.0.69:443/accessv2" \
  ...
  -d '{"apiuser":"bal","apipass":"PASSWORD","cmd":"notice"}'
```
