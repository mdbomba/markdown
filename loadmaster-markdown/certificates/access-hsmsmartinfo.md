...
Handles hsmsmartinfo.

## Endpoint

```text
GET https://<host>:<port>/access/hsmsmartinfo
```
...
```bash
curl -sk -u "bal:PASSWORD" "https://10.0.0.69:443/access/hsmsmartinfo"
```
...
curl -sk -X POST "https://10.0.0.69:443/accessv2" \
  ...
  -d '{"apiuser":"bal","apipass":"PASSWORD","cmd":"hsmsmartinfo"}'
```
