...
curl -sk -X POST "https://<host>:<port>/accessv2" \
  -d '{"apiuser":"bal","apipass":"PASSWORD","cmd":"setacmedirectoryurl", "param": "value"}'
```

### APIv1 (Fallback)

```text
GET https://<host>:<port>/access/setacmedirectoryurl?directoryurl=<value>&acmetype=<value>
```
...
|-----------|------|----------|-------------|
| `directoryurl` | string | See notes | See description |
| `acmetype` | string | See notes | See description |

## Example Request (APIv1)

```bash
curl -sk -u "bal:PASSWORD" "https://10.0.0.14/access/setacmedirectoryurl?directoryurl=https://acme-v02.api.letsencrypt.org/directory&acmetype=1"
```
...
curl -sk -X POST "https://10.0.0.14/accessv2" \
  -d '{"apiuser": "bal", "apipass": "PASSWORD", "cmd": "setacmedirectoryurl", "directoryurl": "https://acme-v02.api.letsencrypt.org/directory", "acmetype": "1"}'
```
