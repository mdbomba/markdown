...
**PS Cmdlet**: `Get-LEAccountInfo`

## Description

Retrieves leaccount info.

## Endpoint

```text
GET https://<host>:<port>/access/leaccountinfo
```
...
```bash
curl -sk -u "bal:PASSWORD" "https://10.0.0.69:443/access/leaccountinfo"
```
...
curl -sk -X POST "https://10.0.0.69:443/accessv2" \
  ...
  -d '{"apiuser":"bal","apipass":"PASSWORD","cmd":"leaccountinfo"}'
```
