...
curl -sk -X POST "https://10.0.0.69:443/accessv2" \
  ...
  -d '{"apiuser":"bal","apipass":"PASSWORD","cmd":"addlecert","cert":"example","vid":"example","country":"example","state":"example","city":"example","company":"example","organization":"example","email":"example","san1":"example","san2":"example","san3":"example","san4":"example","san5":"example","san6":"example","san7":"example","san8":"example","san9":"example","san10":"example","vid1":"example","vid2":"example","vid3":"example","vid4":"example","vid5":"example","vid6":"example","vid7":"example","vid8":"example","vid9":"example","vid10":"example"}'
```
