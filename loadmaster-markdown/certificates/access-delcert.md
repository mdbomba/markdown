...
**PS Cmdlet**: `Remove-TlsCertificate`

## Description

Removes TLS certificate.

## Endpoint

```text
POST https://<host>:<port>/access/delcert?name=<name>[&...]
```
...
```bash
curl -sk -u "bal:PASSWORD" -X POST "https://10.0.0.69:443/access/delcert?name=example-name"
```
...
curl -sk -X POST "https://10.0.0.69:443/accessv2" \
  ...
  -d '{"apiuser":"bal","apipass":"PASSWORD","cmd":"delcert","name":"example-name","force":"1"}'
```
